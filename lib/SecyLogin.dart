...
class SecyLogin extends StatefulWidget {
  const SecyLogin({Key key}) : super(key: key);

  @override
  _SecyLoginState createState() => _SecyLoginState();
}

class _SecyLoginState extends State<SecyLogin> {
  @override
  void initState() {
                          ...
                          onPressed: () async {
                            try {
                              ...
                              if (user != null) {
                                ...
                                Navigator.pushReplacementNamed(context, 'secylist');
                              }
